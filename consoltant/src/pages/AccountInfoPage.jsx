    ...
    <div>
      ...
      <div className="h-[80vh] flex flex-col justify-center items-center">
        ...
        <div className="my-[0.5rem] flex text-[#5C5C5C] w-[40%] max-w-[35rem] min-w-[25rem] items-center justify-between text-[0.9rem]">
          ...
          />
          <button className="border w-[8rem] p-[0.2rem] text-[0.8rem] rounded-[0.2rem] ml-[0.3rem]">
            인증하기
          </button>
        </div>
        {/* 인증 메시지 */}
        <div className="my-[0.5rem] flex text-[#5C5C5C] w-[40%] max-w-[35rem] min-w-[25rem] items-center justify-between text-[0.9rem]">
          ...
          <div className="w-[30rem] flex justify-between">
            <input
              type="text"
              className="border rounded-[0.2rem] w-[3rem] p-[0.2rem] text-[1rem] text-center font-OneShinhanMedium focus:outline-none"
            />
            <input
              type="text"
              className="border rounded-[0.2rem] w-[3rem] p-[0.2rem] text-[1rem] text-center font-OneShinhanMedium focus:outline-none"
            ...
            <button className="border w-[4rem] p-[0.2rem] text-[0.8rem] rounded-[0.2rem] ml-[0.3rem]">
              확인
            </button>
          </div>
        </div>
