  ...
  const options = {
    ...
    animation: {
      ...
      onComplete: function(animation) {
        ...
        const activeIndex = labelData.indexOf('3년');
    ...
    plugins: {
      ...
      tooltip: {
        ...
        backgroundColor: (context) => {
          ...
          return labelData[index] === '3년' ? 'rgba(0, 93, 249, 0.8)' : 'rgba(0, 0, 0, 0.8)';
        },
        borderColor: (context) => {
          // 3년차일 때 툴팁 보더 색상을 변경
          const index = context.tooltip.dataPoints[0].dataIndex;
          return labelData[index] === '3년' ? 'rgba(0, 93, 249, 0.8)' : 'rgba(0, 0, 0, 0.3)';
        },
        titleColor: '#ffffff',
        bodyColor: '#ffffff',
        borderWidth: 2,
